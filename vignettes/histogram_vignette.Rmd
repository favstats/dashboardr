...
vignette: >
  %\VignetteIndexEntry{Creating Histograms with viz_histogram()}
...
- Showing distribution of a continuous variable
- Analyzing spread and shape of data
...
- `?viz_histogram` - Full function documentation
- `vignette("bar_vignette")` - For categorical data
