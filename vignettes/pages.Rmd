...
> **See it in action:** Check out the [Loading Overlay Demo](../live-demos/overlay/index.html) to see all four overlay themes. Reload each page to see the overlay effect.
