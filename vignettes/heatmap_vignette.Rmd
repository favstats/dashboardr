...
# Check the first few variable names to understand the structure
head(names(gss_panel20), 20)
...
Let's use value mapping to create more readable labels and demonstrate different aggregation functions.
