...
<p>See this code in action! <strong><a href="../live-demos/showcase/index.html">Click here to view the Showcase Dashboard live demo →</a></strong></p>
...
```{r demographics-happiness-education-code}
...
```{r demographics-happiness-gender-code}
add_viz(type = "stackedbar",
        x_var = "sex_1a",
        stack_var = "happy_1a",
...
```{r social-trust-education-age-code}
...
```{r social-trust-region-education-code}
add_viz(type = "heatmap",
        x_var = "region_1a",
        y_var = "degree_1a",
        value_var = "trust_1a",
...
```{r summary-happiness-education-code}
add_viz(type = "stackedbar",
        x_var = "degree_1a",
        stack_var = "happy_1a",
...
- **[View the live Showcase Dashboard →](../live-demos/showcase/index.html)**
