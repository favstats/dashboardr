...
result <- tryCatch({
  ...
  stop("Visualization failed ('{dimension}: {question} by {breakdown}', type 'stackedbar'): ", conditionMessage(e), call. = FALSE)
})
...
result <- tryCatch({
  viz_stackedbar(
    ...
    stacked_type = "percent",
    horizontal = TRUE,
    stack_order = c("All", "Male", "Female", "Other", "Black", "White", "60+", "45-59", "30-44", "18-29", "Bachelors+", "Some College", "HS or Less", "Conservative", "Moderate", "Liberal"),
    ...
    stack_label = "Group",
    color_palette = c("All" = "#4E79A7", "Male" = "#F28E2B", "Female" = "#E15759", "Other" = "#76B7B2", "Black" = "#59A14F", "White" = "#EDC948", "60+" = "#B07AA1", "45-59" = "#FF9DA7", "30-44" = "#9C755F", "18-29" = "#BAB0AC", "Bachelors+" = "#4E79A7", "Some College" = "#F28E2B", "HS or Less" = "#E15759", "Conservative" = "#E15759", "Moderate" = "#76B7B2", "Liberal" = "#4E79A7"),
    backend = "plotly",
    cross_tab_filter_vars = c("dimension", "question", "time_period", "breakdown_type")
  )
}, error = function(e) {
  stop("Visualization failed ('{dimension}: {question} by {breakdown} ({time_period})', type 'stackedbar'): ", conditionMessage(e), call. = FALSE)
})
...
result <- tryCatch({
  viz_timeline(
    ...
    agg = "none",
    group_order = c("Liberal", "Moderate", "Conservative", "HS or Less", "Some College", "Bachelors+", "18-29", "30-44", "45-59", "60+", "White", "Black", "Other", "Female", "Male", "All"),
    color_palette = c("All" = "#4E79A7", "Male" = "#F28E2B", "Female" = "#E15759", "Other" = "#76B7B2", "Black" = "#59A14F", "White" = "#EDC948", "60+" = "#B07AA1", "45-59" = "#FF9DA7", "30-44" = "#9C755F", "18-29" = "#BAB0AC", "Bachelors+" = "#4E79A7", "Some College" = "#F28E2B", "HS or Less" = "#E15759", "Conservative" = "#E15759", "Moderate" = "#76B7B2", "Liberal" = "#4E79A7"),
    x_label = "Year",
  ...
  stop("Visualization failed ('{dimension} - {question}: % responding \'{key_response}\' by {breakdown}', type 'timeline'): ", conditionMessage(e), call. = FALSE)
})
