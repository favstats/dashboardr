...
##TODO: now there is always a "tutorial page" that needs fixing
##TODO: for add page / add_viz we also need to have the ability to add some custom text above
##TODO: should there be a function to add an "about page"? or is that just an empty page with text (like the landing page). but should there even be a function called add_landingpage or do we maybe want a general function that is add_page() and depending hether you pass an md or visualization it know what to do..
##TODO: Nice to have: add an argument for a logo?
##TODO: Nice to have: add possibility to add icons?
