# Build Sidebar GSS Explorer Demo Dashboard
...
#   - add_input(): wave year, Compare by breakdowns
#   - add_viz(show_when = ~ ...): stacked bar for a single year, timeline for trend
#
# Run from package root: source("pkgdown/build-sidebar-gss-demo.R")
...
cat("📊 Building Sidebar GSS Explorer Demo Dashboard...\n\n")
...
output_dir <- file.path(pkg_root, "docs", "live-demos", "sidebar-gss")
...
# =============================================================================
# Aggregate: bar data (wave years x breakdown types)
# =============================================================================

cat("📄 Aggregating bar data...\n")
...
# =============================================================================
# Aggregate: timeline data (all years x breakdown types)
# =============================================================================

cat("📄 Aggregating timeline data...\n")
...
dashboard <- create_dashboard(
  ...
  add_page("About", icon = "ph:info", navbar_align = "right",
           content = about_content) %>%
  add_powered_by_dashboardr(style = "minimal")

generate_dashboard(dashboard, render = TRUE, open = FALSE)

cat("\n✅ Sidebar GSS Explorer demo built successfully!\n")
cat("   Location:", output_dir, "\n")
cat("   Open:", file.path(output_dir, "explorer.html"), "\n\n")
