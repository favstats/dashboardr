...
critical_info_visualizations <- (cis_viz + critinfo_viz + perf_cis_viz) %>%
  set_tabgroup_labels(
    ...
    age = "Age", gender = "Gender", edu = "Education",
    overtime = "Over Time", overall = "Overall",
    item1 = "Question 1", item2 = "Question 2", item3 = "Question 3"
  )
...
netiquette_visualizations <- (nskills_viz + knet_viz) %>%
  set_tabgroup_labels(
    ...
    age = "Age", gender = "Gender", edu = "Education",
    overtime = "Over Time", overall = "Overall",
    item1 = "Question 1", item2 = "Question 2", item3 = "Question 3", item4 = "Question 4"
  )
...
safety_visualizations <- (safety_viz + ksafety_viz + perf_safety_viz) %>%
  set_tabgroup_labels(
    ...
    overtime = "Over Time", overall = "Overall",
    item1 = "Question 1", item2 = "Question 2", item3 = "Question 3",
    item4 = "Question 4", item5 = "Question 5", item6 = "Question 6",
    item7 = "Question 7", item8 = "Question 8", item9 = "Question 9"
  )
...
health_visualizations <- (dhealth_viz + khealth_viz + perf_health_viz) %>%
  set_tabgroup_labels(
    ...
    overtime = "Over Time", overall = "Overall",
    item1 = "Question 1", item2 = "Question 2", item3 = "Question 3",
    item4 = "Question 4", item5 = "Question 5", item6 = "Question 6", item7 = "Question 7"
  )
...
green_visualizations <- (green_viz + kgreen_viz + perf_green_viz) %>%
  set_tabgroup_labels(
    ...
    item1 = "Question 1", item2 = "Question 2", item3 = "Question 3",
    item4 = "Question 4", item5 = "Question 5", item6 = "Question 6",
    item7 = "Question 7", item8 = "Question 8"
  )
...
transactional_visualizations <- (trans_viz + ktrans_viz + perf_trans_viz) %>%
  set_tabgroup_labels(
    ...
    overtime = "Over Time", overall = "Overall",
    item1 = "Question 1", item2 = "Question 2", item3 = "Question 3",
    item4 = "Question 4", item5 = "Question 5"
  )
