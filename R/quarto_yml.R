...
.generate_quarto_yml <- function(proj) {
  ...
  tab_jump_fix_script <- c(
    ...
    "                // Only handle actual Bootstrap tabs, not regular anchor links",
    "                // Tabs have role='tab' or data-bs-toggle='tab'",
    "                var isActualTab = this.getAttribute('role') === 'tab' || ",
    "                                  this.getAttribute('data-bs-toggle') === 'tab' ||",
    "                                  this.getAttribute('aria-controls');",
    "                if (!isActualTab) {",
    "                  // This is a regular anchor link - let it work normally",
    "                  return;",
    "                }",
    "                ",
    ...
    "                ",
    "                // Prevent default hash navigation (only for tab links)",
    "                e.preventDefault();",
    "                ",
