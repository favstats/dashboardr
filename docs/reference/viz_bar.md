...
- cross_tab_filter_vars:
  ...
  Optional character vector of variable names to use as cross-tab filter
  controls for this chart. Enables dynamic filtering.

- title_map:

  Optional named list mapping filter values to custom chart titles. When
  cross_tab_filter_vars are used, this controls the displayed title for
  each filter value.
