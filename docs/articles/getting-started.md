...
Now that we’ve made our very first dashboard, let’s break it down so
that we can add a bit of functionality and flexibility. Every dashboard
follows the same pattern. Let’s understand each step in depth.

### Step 1: Build Visualizations

Before we start actually creating the visualizations that are
dashboard-ready, we generally recommend exploring the core visualization
functions in order to actually see what your plots will look like. Let’s
take the above histogram example and examine what it actually looks
like:
...
function is the function that is actually used under the hood. The same
holds for all other visualization types. For instance, the visualization
function that renders heat maps is
[`create_heatmap()`](https://favstats.github.io/dashboardr/reference/create_heatmap.md).
It is worth reading through each of the visualization function
documentation and vignettes, especially if you plan to use `dashboardr`
for deeper or more complex work.

Now that we’re happy with the result, we can set up the dashboard
objects. We can create a collection of charts that share common
...
Instead of repeating the same parameters for every chart, you set them
once. This is the DRY principle (Don’t Repeat Yourself) in action!
...
Next, you can configure the dashboard itself and add pages with
...
`dashboardr` then creates Quarto files (.qmd) and optionally renders
them to HTML.
...
## Previewing Individual Visualizations

dashboardr makes it easy to preview individual visualizations before
building a full dashboard. Just attach your data and the visualization
renders automatically!

``` r
# When you attach data, the visualization renders inline!
create_viz(data = survey_data, type = "histogram") %>%
  add_viz(x_var = "age", title = "Age Distribution")
```

#### Age Distribution

Multiple visualizations render stacked:
...
When you use tabgroups, visualizations render with interactive tabs:

``` r
create_viz(data = survey_data, type = "histogram") %>%
  add_viz(x_var = "age", title = "Age", tabgroup = "Demographics") %>%
  add_viz(x_var = "income", title = "Income", tabgroup = "Demographics") %>%
...
**Another killer feature:** When you print a visualization object
*without data*, it shows you the **tree structure** it will create. This
makes the hierarchy visible and debuggable!

``` r
# Create a visualization collection WITHOUT data
# This shows structure instead of rendering
...
# Print shows the tree structure (no data = structure view)
print(viz)
#> 
#> <e2><95><94><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90>
#> <e2><95><91> <f0><9f><93><a6> CONTENT COLLECTION
#> <e2><95><a0><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90>
#> <e2><95><91> Total items: 3
#> <e2><95><91>
#> <e2><95><91> STRUCTURE:
#> <e2><95><91> <e2><94><9c><e2><94><80> <f0><9f><93><81> demographics
#> <e2><95><91> <e2><94><82>  <e2><94><9c><e2><94><80> <f0><9f><93><84> VIZ: Age Distribution
#> <e2><95><91> <e2><94><82>  <e2><94><94><e2><94><80> <f0><9f><93><84> VIZ: Income Distribution
#> <e2><95><91> <e2><94><94><e2><94><80> <f0><9f><93><81> feedback
#> <e2><95><91>    <e2><94><94><e2><94><80> <f0><9f><93><84> VIZ: Satisfaction Scores
#> <e2><95><9a><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90>
```
...
### Two Modes: Preview vs Structure

- **With data attached** → Auto-renders the visualization
- **Without data** → Shows the structure tree

``` r
# MODE 1: Renders as interactive chart (data attached)
create_viz(data = survey_data, type = "histogram") %>%
  add_viz(x_var = "age", title = "Age")

# MODE 2: Shows structure tree (no data)
...
for more control over rendering, including Quarto-based rendering with
full tabset support:

``` r
# Quick preview in viewer
viz <- create_viz(data = survey_data) %>%
  add_viz(type = "histogram", x_var = "age")
preview(viz)  # Opens in RStudio Viewer

# Save to specific location
preview(viz, path = "~/Desktop/my_preview.html")

# Use Quarto for full tabset rendering (requires Quarto installed)
preview(viz, quarto = TRUE)
```
...
#> <e2><95><91>
#> <e2><95><91> STRUCTURE:
#> <e2><95><91> <e2><94><94><e2><94><80> <f0><9f><93><81> analysis
#> <e2><95><91>    <e2><94><9c><e2><94><80> <f0><9f><93><81> demographics
#> <e2><95><91>    <e2><94><82>  <e2><94><9c><e2><94><80> <f0><9f><93><81> age
#> <e2><95><91>    <e2><94><82>  <e2><94><82>  <e2><94><94><e2><94><80> <f0><9f><93><84> VIZ: Age
#> <e2><95><91>    <e2><94><82>  <e2><94><94><e2><94><80> <f0><9f><93><81> income
#> <e2><95><91>    <e2><94><82>     <e2><94><94><e2><94><80> <f0><9f><93><84> VIZ: Income
#> <e2><95><91>    <e2><94><94><e2><94><80> <f0><9f><93><81> feedback
#> <e2><95><91>       <e2><94><94><e2><94><80> <f0><9f><93><81> overall
#> <e2><95><91>          <e2><94><94><e2><94><80> <f0><9f><93><84> VIZ: Overall Satisfaction
#> <e2><95><9a><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90>
```
...
#> <e2><95><91> <f0><9f><93><a6> CONTENT COLLECTION
#> <e2><95><a0><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90>
#> <e2><95><91> Total items: 2
#> <e2><95><91>
#> <e2><95><91> STRUCTURE:
#> <e2><95><91> <e2><94><9c><e2><94><80> <f0><9f><93><81> demographics
#> <e2><95><91> <e2><94><82>  <e2><94><94><e2><94><80> <f0><9f><93><84> VIZ: Age
#> <e2><95><91> <e2><94><94><e2><94><80> <f0><9f><93><81> feedback
#> <e2><95><91>    <e2><94><94><e2><94><80> <f0><9f><93><84> VIZ: Satisfaction
#> <e2><95><9a><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90>
```
...
#> <e2><95><91>
#> <e2><95><91> STRUCTURE:
#> <e2><95><91> <e2><94><94><e2><94><80> <f0><9f><93><81> (no tabgroup)
#> <e2><95><91>    <e2><94><9c><e2><94><80> <f0><9f><93><84> VIZ: Age (uses defaults)
#> <e2><95><91>    <e2><94><94><e2><94><80> <f0><9f><93><84> VIZ: Income (custom)
#> <e2><95><9a><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90>
```
...
#> <e2><95><91> STRUCTURE:
#> <e2><95><91> <e2><94><94><e2><94><80> <f0><9f><93><81> analysis
#> <e2><95><91>    <e2><94><9c><e2><94><80> <f0><9f><93><84> VIZ: Age Distribution
#> <e2><95><91>    <e2><94><94><e2><94><80> <f0><9f><93><84> VIZ: Age Distribution
#> <e2><95><9a><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90>
```
...
#> <e2><95><91>
#> <e2><95><91> STRUCTURE:
#> <e2><95><91> <e2><94><94><e2><94><80> <f0><9f><93><81> survey
#> <e2><95><91>    <e2><94><9c><e2><94><80> <f0><9f><93><84> VIZ: Question 1
#> <e2><95><91>    <e2><94><9c><e2><94><80> <f0><9f><93><84> VIZ: Question 2
#> <e2><95><91>    <e2><94><94><e2><94><80> <f0><9f><93><84> VIZ: Question 3
#> <e2><95><9a><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90><e2><95><90>
```
