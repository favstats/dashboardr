...
degree who are “very happy”, the cell shows their average age. You can
change this with `agg_fun` (e.g., `agg_fun = median` for medians).
...
#> 1 items | ✖ no data
#> 
#> ℹ [Text] "## Key Findings This analysis reveals **three i..."
```
...
#> 2 items | ✖ no data
#> 
#> ℹ [Text] "### Summary Statistics by Education"
#> • [gt]
```
...
#> 2 items | ✖ no data
#> 
#> ℹ [Text] "### Interactive Summary Table"
#> • [reactable]
```
...
#> 2 items | ✖ no data
#> 
#> ℹ [Text] "### DataTable with Search and Pagination"
#> • [DT]
```
...
#> 3 items | ✖ no data
#> 
#> ℹ [Text] "## Section One Content for the first section."
#> ─ [Divider]
#> ℹ [Text] "## Section Two Content for the second section."
```
...
#> 3 items | ✖ no data
#> 
#> ℹ [Text] "Content above"
#> • [spacer]
#> ℹ [Text] "Content below (after 3rem spacer)"
```
