...
See this code in action! **[Click here to view the Showcase Dashboard
live demo
→](https://favstats.github.io/dashboardr/live-demos/showcase/index.md)**

Or run it yourself:
[`dashboardr::showcase_dashboard()`](https://favstats.github.io/dashboardr/reference/showcase_dashboard.md)

## Overview

This vignette provides the **exact R code** for each visualization in
the Showcase Dashboard. Each section shows the complete
...
**Note:** This chart uses `stacked_type = "counts"` instead of
“percent”.
...
- **[View the live Showcase Dashboard
  →](https://favstats.github.io/dashboardr/live-demos/showcase/index.md)**
- See the [Tutorial Dashboard
  Code](https://favstats.github.io/dashboardr/articles/tutorial_dashboard_code.md)
